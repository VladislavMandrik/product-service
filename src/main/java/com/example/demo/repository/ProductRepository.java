...
public interface ProductRepository extends ReactiveCrudRepository<Product, Long> {
    @Query(value = "select products.id, products.name, products.description, " +
            "brands.name AS brand, categories.name AS category, products.create_at, products.update_at " +
    ...
    @Query(value = "select products.id, products.name, products.description, brands.name AS brand, " +
            "categories.name AS category, products.create_at, products.update_at from products " +
